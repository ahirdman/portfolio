...
const LineArrow = ({ className }: ISVGProps) => (
  ...
  >
    <path
      fill="#000"
      d="M9 1a1 1 0 0 0-2 0h2ZM7.293 437.707a1 1 0 0 0 1.414 0l6.364-6.364a1 1 0 1 0-1.414-1.414L8 435.586l-5.657-5.657a1 1 0 1 0-1.414 1.414l6.364 6.364ZM7 1v436h2V1H7Z"
    />
    <path
      fill="#000"
